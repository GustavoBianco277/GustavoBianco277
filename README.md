...
Unity Developer focused on **2D and 3D game development**, with strong experience in **multiplayer systems**, server-side architecture, and **performance optimization**, especially for **mobile and online games**.

I am currently developing a **3D online survival game**, applying multiplayer best practices, scalable systems, and performance-oriented gameplay design.

I build scalable systems, efficient gameplay solutions, and professional-grade tools for commercial projects and Unity assets.

- 🎮 Unity Developer (C#)
- 🌐 Multiplayer: Photon Fusion
- 🧱 Currently developing a **3D Online Survival Game** and a **server-side anti-wallhack system**
- ⚙️ Focus on performance, optimization, and architecture
- 🧠 Continuously improving in Game Development
...
<div align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=unity,cs,python,java,js,html,css,mysql,git" />
  </a>
</div>
...
![Snake animation](https://github.com/gustavobianco277/gustavobianco277/blob/output/github-contribution-grid-snake.svg)
